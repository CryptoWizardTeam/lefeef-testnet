...
localnet-unsafe-reset:
	docker-compose down
ifeq ($(OS),Windows_NT)
	@docker run --rm -v $(CURDIR)\build\node0\lefeefd:/evmos\Z evmos/node "./lefeefd tendermint unsafe-reset-all --home=/evmos"
	@docker run --rm -v $(CURDIR)\build\node1\lefeefd:/evmos\Z evmos/node "./lefeefd tendermint unsafe-reset-all --home=/evmos"
	@docker run --rm -v $(CURDIR)\build\node2\lefeefd:/evmos\Z evmos/node "./lefeefd tendermint unsafe-reset-all --home=/evmos"
	@docker run --rm -v $(CURDIR)\build\node3\lefeefd:/evmos\Z evmos/node "./lefeefd tendermint unsafe-reset-all --home=/evmos"
else
	@docker run --rm -v $(CURDIR)/build/node0/lefeefd:/evmos:Z evmos/node "./lefeefd tendermint unsafe-reset-all --home=/evmos"
	@docker run --rm -v $(CURDIR)/build/node1/lefeefd:/evmos:Z evmos/node "./lefeefd tendermint unsafe-reset-all --home=/evmos"
	@docker run --rm -v $(CURDIR)/build/node2/lefeefd:/evmos:Z evmos/node "./lefeefd tendermint unsafe-reset-all --home=/evmos"
	@docker run --rm -v $(CURDIR)/build/node3/lefeefd:/evmos:Z evmos/node "./lefeefd tendermint unsafe-reset-all --home=/evmos"
endif
